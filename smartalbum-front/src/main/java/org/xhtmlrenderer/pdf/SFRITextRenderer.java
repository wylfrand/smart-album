...
public class SFRITextRenderer extends ITextRenderer{
    ...
    public SFRITextRenderer() {
        this(DEFAULT_DOTS_PER_POINT, DEFAULT_DOTS_PER_PIXEL);
    }

    public SFRITextRenderer(float dotsPerPoint, int dotsPerPixel) {
        _dotsPerPoint = dotsPerPoint;

        _outputDevice = new ITextOutputDevice(_dotsPerPoint);

        SFRITextUserAgent userAgent = new SFRITextUserAgent(_outputDevice);
