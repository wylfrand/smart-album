...
public class FileUtils {
    ...
    public static FilenameFilter imageFilter = new FilenameFilter() {
		public boolean accept(File dir, String name) {
			...
			if (lowercaseName.endsWith(".jpg") || lowercaseName.endsWith(".jpeg") || lowercaseName.endsWith(".gif") || lowercaseName.endsWith(".png")) {
				return true;
			} else {
				return false;
			}
	...
	public static FilenameFilter directoryFilter = new FilenameFilter() {
		public boolean accept(File dir, String name) {
			...
			File currentUserName = new File(dir.getPath()+File.separator+name);
			if (currentUserName.isDirectory()) {
				return true;
			} else {
				return false;
			}
    ...
    public static void copyDirectory(File srcDir, File dstDir)
        ...
        if (srcDir.isDirectory()) {
            ...
            for (String aChildren : srcDir.list(imageFilter)) {
     ...
     * @param format - file suffixe of the image
