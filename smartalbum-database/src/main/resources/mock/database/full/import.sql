INSERT INTO User(id, firstname, secondname, email, login, passwordHash, birthdate, sex, hasAvatar, preDefined) VALUES (1,  'Andrey', 'Markhel', 'amarkhel@exadel.com',  'amarkhel', 'amarkhel',  '1985-01-08', 0, false, true);
INSERT INTO User(id, firstname, secondname, email, login, passwordHash, birthdate, sex, hasAvatar, preDefined) VALUES (2,  'Nick',   'Curtis',  'nkurtis@iba.com',      'viking',   'viking',  '1978-01-08', 1, false, true);
INSERT INTO User(id, firstname, secondname, email, login, passwordHash, birthdate, sex, hasAvatar, preDefined) VALUES (3,  'John',   'Smith',   'jsmith@jboss.com',     'noname',   'noname',  '1970-01-08', 1, false, true);
