...
<!-- Tabs -->
<link rel="stylesheet"
	href="<c:url value='/css/layer_en_savoir_plus/widget.css'/>"
	media="all" />
<link rel="stylesheet"
	href="<c:url value='/css/layer_en_savoir_plus/layer_en_savoir_plus.css'/>"
	media="all" />

<script src="<c:url value='/js/custom/layer_en_savoir_plus.js'/>"></script>
...
<script language="javascript" type="text/javascript"
	...
	<script language="javascript" type="text/javascript"
	src="<c:url value='/js/lib/lib.uploadAlbums.js'/>"></script>
	
	<script language="javascript" type="text/javascript"
	src="<c:url value='/js/lib/lib.blogAlbums.js'/>"></script>
...
<script
	src="<c:url value='/templates/netbased/js/jquery.jcarousel.js'/>"
