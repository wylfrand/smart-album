...
public abstract class MessageHTMLBaseVO implements Serializable{
	 ...
	 *            - comment to add
	 */
	public void addMessagePart(MessagePartVO messagePart) {
		if (messagePart == null) {
	...
	public void updateHTMLDescription() {
		...
		int newOrder = 1;
		for (MessagePartBaseVO part : getMessageLinesBase()) {
	 ...
	 *            - image to remove
	 */
	public void removePart(MessagePartVO part) {
		if (part == null) {
	...
	public abstract List<MessagePartBaseVO> getMessageLinesBase();
